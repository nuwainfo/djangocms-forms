# -*- coding: utf-8 -*-
# Generated by Django 1.11.29 on 2020-04-20 11:50
...
class Migration(migrations.Migration):
    ...
    operations = [
        ...
        migrations.AlterField(
            model_name='formdefinition',
            name='form_template',
            field=models.CharField(blank=True, choices=[('djangocms_forms/form_template/default.html', 'Default'), ('landing/LandingForm.html', 'Landing Form'), ('blog_extension/call_to_action/DefaultForm.html', 'Default Call To Action Form Template')], default='djangocms_forms/form_template/default.html', max_length=150, verbose_name='Form Template'),
        ),
        migrations.AlterField(
